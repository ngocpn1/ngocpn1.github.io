...
document.querySelector('#asteroid').innerHTML = "The asteroid named " + asteroid.name + " is between " + asteroid.estimated_diameter.miles.estimated_diameter_min + " and " + asteroid.estimated_diameter.miles.estimated_diameter_max + " miles wide, and will miss striking Earth by approximately " + asteroid.close_approach_data[0].miss_distance.miles + " miles.<br><br>";

document.querySelector('#link').innerHTML = "<a href=" + asteroid.links.self + "> Click here to learn more about Helen :) </a>";
